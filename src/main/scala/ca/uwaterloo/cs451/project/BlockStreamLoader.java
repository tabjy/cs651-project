 ...
 * }</p>
 */
public class BlockStreamLoader implements Iterable<Block>, Iterator<Block> {
    private Iterator<InputStream> fileIt;
    private InputStream file = null;
    private InputStream currentFileStream = null;
    private Block nextBlock = null;
    private NetworkParameters params;
    public BlockStreamLoader(NetworkParameters params, List<InputStream> files) {
        fileIt = files.iterator();
        this.params = params;
    }
    public BlockStreamLoader(NetworkParameters params, InputStream file) {
        fileIt = Collections.singletonList(file).iterator();
        this.params = params;
    }
